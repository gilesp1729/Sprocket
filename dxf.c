...
)
{
    ...
    double      a1 = PI/2 - atan2(xstart - xc, ystart - yc);
    double      a2 = PI/2 - atan2(xend - xc, yend - yc);
    int		npts = 20;   /// fix later to depend on angle
    double	rad = (x2 - x1) / 2;
    int		i;
    double	da = PI/25;
